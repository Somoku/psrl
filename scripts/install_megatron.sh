...
NVTE_FRAMEWORK=pytorch python -m pip install --no-build-isolation git+https://github.com/NVIDIA/TransformerEngine.git@v2.6

echo "3. Install Megatron"
python -m pip install --no-deps git+https://github.com/NVIDIA/Megatron-LM.git@core_v0.13.1
