Scripts in this directory are guaranteed to run successfully end-to-end and converge as expected. Additionally, results will be uploaded to `wandb.ai` website.
