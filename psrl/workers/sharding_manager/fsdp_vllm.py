...
class PSRL_FSDPvLLMShardingManager(BaseShardingManager):
    ...
    def __init__(self, module: FSDP, inference_engine: LLM, model_config, seed: int = 0, full_params: bool = False, device_mesh: DeviceMesh = None, offload_param: bool = False, load_format: str = "dummy_hf", layered_summon: bool = True):
        ...
        if self.device_mesh is not None:
            get_torch_device().manual_seed(seed)  # make sure all tp ranks have the same random states
...
class PSRL_FSDPASyncvLLMShardingManager(BaseShardingManager):
    @check_device_is_available()
    def __init__(self, module: FSDP, inference_engine: AsyncLLM, model_config, seed: int = 0, full_params: bool = False, device_mesh: DeviceMesh = None, offload_param: bool = False, load_format: str = "dummy_hf", layered_summon: bool = True):
        self.module = module
