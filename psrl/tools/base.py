...
class Tool:
    ...
    def forward(self, *args, **kwargs) -> tuple[ToolOutput, float | None]:
        """
        ...
        Returns:
            tuple: (ToolOutput, optional_reward) where ToolOutput contains the
                   result and optional_reward is a float if applicable
    ...
    async def async_forward(self, *args, **kwargs) -> tuple[ToolOutput, float | None]:
        """
