...
python plot.py /jizhicfs/lhy/psrl_smg/examples/mini_swe/megatron_psrl_log/free_mig_async_GRPO-SWE-agent-LM-7B-swe_gym-megatron-staleness_1 \
--substring stats_r \
--xlabel "time(s)" \
--ylabel "instance request num" \
--out free_mig_async_request_num.png \
--mode subplot \
