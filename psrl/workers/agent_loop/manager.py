...
class PSRL_AgentLoopManager:
    ...
    def start_busy_loop(self):
        ...
        if (
            self.dispatch_task is not None and not self.dispatch_task.done() or
            self.collect_task is not None and not self.collect_task.done()
        ):
            return
    ...
    async def stop_busy_loop(self):
        ...
        if (
            (not self.dispatch_task or self.dispatch_task.done()) and
