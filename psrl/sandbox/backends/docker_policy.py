...
def rewrite_loopback_proxy(value: str, host_alias: str) -> str:
    """
    Replace a URL's loopback host with the Docker host gateway alias.

    Args:
        value (str): URL or `host:port` authority, with or without a scheme.
        host_alias (str): Alias mapped to `host-gateway` for this workload.
