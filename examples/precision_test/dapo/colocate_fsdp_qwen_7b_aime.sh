...
experiment_name='DAPO-Qwen2.5-7B-AIME-colocate-fsdp1-batch-nixl-staleness_0'
...
GEN_INSTANCES=1
GEN_NGPUS_PER_NODE_PER_INSTANCE=${NGPUS_PER_NODE}
...
PYTHONUNBUFFERED=1 python -m psrl.trainer.main_ppo \
    ...
    psrl.deployment.rollout_nnodes_per_instance=${GEN_NNODES} \
