"""
NIXL end-to-end test.

Requires: multi-GPU node with megatron, nixl, and full PSRL environment.
Run via: python tests/nixl/test_nixl_e2e.py (on a GPU node with env activated).
